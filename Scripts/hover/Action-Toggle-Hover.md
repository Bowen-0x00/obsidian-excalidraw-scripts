---
name: 阴影与交互设置
description: 强大的多图层视觉控制器。独立管理“静态长亮阴影”与“悬停交互效果”，支持无限叠加图层。
author: ymjr
version: 1.0.0
license: MIT
usage: 选中画板中的任意元素，运行此脚本打开阴影与交互设置面板，可以为元素添加静态常驻阴影或鼠标悬停时的阴影/发光效果。
features:
  - 提供可视化的多图层阴影管理器UI面板
  - 支持分别为元素配置“静态常亮阴影”和“鼠标悬停特效”
  - 支持向 customData 中注入 shadow 和 hover 配置
dependencies:
  - 依赖 Feature-Hover-Engine 处理鼠标移动与悬停渲染
autorun: false
---
/*
```javascript
